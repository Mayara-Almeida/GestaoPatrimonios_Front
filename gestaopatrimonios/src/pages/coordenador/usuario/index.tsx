...
import { apiCep } from "@/pages/api/api";
...
const Usuario = () => {
    ...
    async function buscarCep(){
        try{
            ...
            const dados = await response.data; // .data -> informações vem da maneira correta como json

            setBairro(dados.bairro); 
            setCidade(dados.localidade); // localidade -> nome que vem do json da api
            ...
            <section className={`${styles.container_cadastro_area} layout_guide`}>
                ...
                <form className={styles.form_cadastro_responsavel}>
                    ...
                    <div className={styles.campo_cadastro_responsavel}>
                        ...
                        onBlur={buscarCep} 
                      />  {/* onBlur = assim que sair do input, vai chamar a função buscarCep */}
                    </div>
