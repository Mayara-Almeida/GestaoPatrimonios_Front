...
const Patrimonio = () => {
    ...
    const inputRef = useRef<HTMLInputElement>(null); // Usado parq eu não dê problema em subir o arquivo com o mesmo nome
                    ...
                    <form className={styles.form_cadastro_area} onSubmit={cadastrarArquivo}>
                        <div className={styles.campo_cadastro_area}>
                            ...
                            <div className={styles.upload_box}>
                                ...
                                onChange={(e) => setArquivo(e.target.files![0])} /> { /* Pegar array de valor zero -- "!" também trabalha com ele podendo sendo ulo ou não, tipo "?" */ }
